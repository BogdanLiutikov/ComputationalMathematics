...
public class GaussSeidel {
    ...
    public void init(double eps, double[][] matrix) {
        this.EPS = eps;
        n = matrix.length;
        m = matrix[0].length;
    ...
    public int solve() {
        ...
        if (nextStep != diagonalZero) {
            ...
            if (makeDominant())
                System.out.println("Удалось привести матрицу к виду с диагональным преобладанием");
            else {
                System.out.println("Не удалось привести матрицу к виду с диагональным преобладанием");
